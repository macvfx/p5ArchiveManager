...
| **API beta** | **v0.9.1** (preview of the upcoming **v4**) | Archiware P5 **REST API** | **Beta — Phase 1 ready for testing** |
...
- **Check for updates (new in 0.9.1)** — daily on launch (silent unless an update exists) and via **app menu ▸ Check for Updates…**; follows only the API-beta `0.x` release line (pre-releases included) and ignores the shipping app's `3.x` releases in this shared repo. Nothing downloads automatically — the alert links to the release page.
...
> Looking for the REST-API build? See the **[API Beta — User Guide](docs/API-BETA-GUIDE.md)** (v0.9.1, preview of v4).
